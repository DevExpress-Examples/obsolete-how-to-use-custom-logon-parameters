...
Namespace CustomLogonParametersExample.Module
    <NonPersistent(), Custom("Caption", "Log On")> _
    Public Class CustomLogonParameters
        Implements ISupportResetLogonParameters, ICustomObjectSerialize
        ...
        Private Sub RefreshAvailableUsers()
            ...
            End If
            If Company Is Nothing Then
                _availableUsers.Criteria = New NotOperator(New BinaryOperator("UserName", SecurityStrategy.AnonymousUserName))
            Else
        ...
        Public ReadOnly Property AvailableUsers() As XPCollection(Of Employee)
            ...
            End Get
        End Property
        Public Sub Reset() Implements ISupportResetLogonParameters.Reset
            ObjectSpace = Nothing
