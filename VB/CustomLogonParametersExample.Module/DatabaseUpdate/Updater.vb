...
Namespace CustomLogonParametersExample.Module.DatabaseUpdate
    Public Class Updater
        ...
        Public Overrides Sub UpdateDatabaseAfterUpdateSchema()
            ...
            End If
            Const adminName As String = "Administrator"
            ...
            If userRole Is Nothing Then
                ...
                userRole.Name = "User"
                userRole.EnsureTypePermissions(Of Employee)(SecurityOperations.ReadOnlyAccess)
                userRole.EnsureTypePermissions(Of Company)(SecurityOperations.ReadOnlyAccess)
            End If
